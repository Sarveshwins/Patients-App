...
const Verifyemail = ({navigation}) => {
  ...
  return (
    ...
    <Text style={styles.signup_text}>You have been sent a verification code on your email.</Text>
    </View> 

    <CommonTextInputotp style={{
        top:138
    }}
    ...
    />
     ...
     Resend verifiction code
        ...
        <TouchableOpacity style={{...styles.verifybutton,  backgroundColor: otp.length === 6 ? '#FF9393' : '#F7F7F7',            shadowColor: otp.length === 6 ? '#FF9393' : '#fff'
}} onPress={() => navigation.navigate('Crosssignnumber')}
            disabled={otp.length !== 6} >
            
            <Text style={{...styles.verifytext,color: otp.length === 6 ? '#FFF' : '#282222',
        }}>Verify</Text>
