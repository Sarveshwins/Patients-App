...
const Changepwsuccess = ({navigation}) => {
  return (
    ...
    <Text style={styles.successful_text}>You have successfully changed your password</Text>
    <Image style={{marginVertical: '35%',alignContent:"center", alignItems:"center"}} source={require("../../assets/logos/success.png")} />
