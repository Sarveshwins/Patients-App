...
const Mesectioncontact = ({navigation}) => {
  ...
  return (
    ...
    <TouchableHighlight underlayColor='transparent' onPress={()=> navigation.navigate("Successful")}>
    ...
    />
     ...
     Resend verifiction code
        ...
        <TouchableHighlight underlayColor='transparent' style={{...styles.verifybutton,  backgroundColor: number.length === 10 ? '#FF9393' : '#F7F7F7',          
...
const styles = StyleSheet.create({
    ...
    export default Mesectioncontact